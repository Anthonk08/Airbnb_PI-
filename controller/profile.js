...
const loadPropertyHistory = async (req,res)=>{
    ...
    if(id_property!=undefined || isNaN(id_property)){
        req.sessionError = 'El id de la propiedad no esta definido o no es un tipo integer';
        res.redirect('/home',{
...
const loadPaymentHistory = async (req,res)=>{
    ...
    if(id_user!=undefined || isNaN(id_user)){
        req.sessionError = 'El id del usuario no esta definido o no es un tipo integer';
        res.redirect('/home',{
            sessionError:req.sessionError
        });
    }
